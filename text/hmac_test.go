...
func TestHmacSha512(t *testing.T) {
	...
	if signature != "2fcb078bae0caf610e46efb16216693ce8bb445e7965d66db175ba66356e3da7a5b4032ecd0b3c31b6b71c2c199cef50e06824649c126766e21fd2099a0cf438" {
		t.Fatal("HMAC SHA512 signature should be 2fcb078bae0caf610e46efb16216693ce8bb445e7965d66db175ba66356e3da7a5b4032ecd0b3c31b6b71c2c199cef50e06824649c126766e21fd2099a0cf438")
	}

	if !HmacVerifySha512("hello", "secretkey", signature) {
		t.Fatal("HMAC SHA512 verification should succeed")
	}

	if HmacVerifySha512("hello", "wrongkey", signature) {
		t.Fatal("HMAC SHA512 verification should fail with wrong key")
	}
}
