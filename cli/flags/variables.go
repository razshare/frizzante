...
var Add = flag.StringP("add", "a", "", "adds features, see  \"-a?\" or \"--add ?\" for more details")
...
var SqlcGenerate = flag.BoolP("sqlc-generate", "", false, "generates sqlc queries")
var CreateSqliteDatabase = flag.BoolP("create-sqlite-database", "", false, "creates an empty sqlite database")
