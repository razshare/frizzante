...
func TestApply(t *testing.T) {
	...
	var search *search3.Search
	// move down
	search = &search3.Search{Filtered: []search3.Choice{{Id: "1"}, {Id: "2"}, {Id: "3"}, {Id: "4"}, {Id: "5"}}}
	...
	search = &search3.Search{Filtered: []search3.Choice{}}
	viewport = &_viewport.Viewport{Cursor: 0, Offset: 0, Visible: 3}
	Apply(search, viewport, 1)
	if viewport.Cursor != 0 {
		t.Fatal("navigate cursor should be 0")
	...
	search = &search3.Search{Filtered: []search3.Choice{{Id: "1"}}}
	viewport = &_viewport.Viewport{Cursor: 0, Offset: 0, Visible: 3}
	Apply(search, viewport, 1)
	if viewport.Cursor != 0 {
		t.Fatal("navigate cursor should be 0")
